...
alias configs-common='git --git-dir=$HOME/.configs-common --work-tree=$HOME'
alias configs-common='git --git-dir=$HOME/.configs-common --work-tree=$HOME'
# export PATH="$HOME/miniconda/bin:$PATH"  # commented out by conda initialize

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/trauco/miniconda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/trauco/miniconda/etc/profile.d/conda.sh" ]; then
        . "/home/trauco/miniconda/etc/profile.d/conda.sh"
    else
        export PATH="/home/trauco/miniconda/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
